...
public class WarehouseReceiver {
    ...
    public void receive(@Payload BookOrder bookOrder, @Header(name="orderState") String orderState, @Header(name="bookOrderId") String bookOrderId,
    		@Header(name="storeId") String storeId, MessageHeaders messageHeaders){
        ...
        LOGGER.info("Message messageHeaders = {}", messageHeaders);
